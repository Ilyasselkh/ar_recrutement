...
const FORM_SELECTOR = ".o_form_view.ar_recrutement_modern:not(.ar_recrutement_popup)";
...
function animateForm(form) {
    if (!form || form.dataset.arRecAnimated === "1") {
        return;
    }
    form.dataset.arRecAnimated = "1";

    const sheet = form.querySelector(".ar_recrutement_sheet");
    if (sheet) {
